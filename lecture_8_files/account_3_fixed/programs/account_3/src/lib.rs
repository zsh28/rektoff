...
pub mod account_3 {
    ...
    pub fn transfer_nft_between_vaults(
        ...
        msg!("AFTER source update: Vault '{}' now has {} NFTs", source.vault_name, source.nft_count);
        ...
        msg!("AFTER destination update: Vault '{}' now has {} NFTs", destination.vault_name, destination.nft_count);
        msg!("SECURE: Transferring NFT {}", nft_mint);
        Ok(())
    }
}
