...
declare_id!("FkrFQ4tWZ5G3aKD75qRYkwzaskWuKnAkyAqMtqCSGu32");
...
/// ✅ LEGITIMATE ROYALTY PROGRAM ✅
///
/// This program handles the distribution of royalties to creators and rights holders
/// when NFTs are sold through the marketplace. It ensures proper allocation of
/// royalty payments according to the configured distribution rules.
